...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FuamF5LW0tZyIsImEiOiJja3ZybWRzbDkxa3QxMnBxaGx5Mnd2Mm5wIn0.6pHLSxOpmmmDewsR3A63_A';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51Ju5WHSGU8S676CyLJ5NJaqz2LYrYGgKcPWmjkifOqsHdxeqMKnoXT8uMIVo7Cf388HcnTjoUKooEyfrCgIsMUix00zKkNR1Nn'); //1.Get checkout session from the API
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var passBtn, passwordCurrent, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              passBtn = document.querySelector('.btn--save-password');
              console.log(passBtn);
            ...
            case 9:
              passBtn.textContent = 'Save password';
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; //tour-id is treated as tourId
